...
export function UserSelector({ onActiveUserChange }: UserSelectorProps) {
  ...
  const refreshUsers = useCallback(() => {
    ...
    onActiveUserChange?.(nextActiveUser);
  }, [onActiveUserChange]);
  ...
  return (
    <div className="user-selector-group">
      <div className="user-selector">
        <svg className="user-selector-icon" width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true">
